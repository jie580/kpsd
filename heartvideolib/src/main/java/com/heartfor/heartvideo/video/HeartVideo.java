...
public class HeartVideo extends FrameLayout implements TextureView.SurfaceTextureListener,
    ...
    protected void dispatchDraw(Canvas canvas) {
        Path path = new Path();
        path.addRoundRect(new RectF(0, 0, getMeasuredWidth(), getMeasuredHeight()), 15, 15, Path.Direction.CW);
...
//        path.addRoundRect(new RectF(0,0,w,h),15,15,Path.Direction.CW);
...
//            contentView.setBackgroundColor(Color.parseColor("#FF9900"));
...
//            mAudioManager.setStreamMute(AudioManager.STREAM_MUSIC , true);
     ...
     * @param flag
     */
    public void setStreamMute(boolean flag)
    {
//        if (mAudioManager != null) {
...
//    public void saveVolume(String key, int result) {
//        getContext().getSharedPreferences("progress", Context.MODE_PRIVATE).edit().putInt(key, result).apply();
//    }
//    public int getVolume(String key) {
//        return getContext().getSharedPreferences("progress", Context.MODE_PRIVATE).getInt(key, 0);
//    }
