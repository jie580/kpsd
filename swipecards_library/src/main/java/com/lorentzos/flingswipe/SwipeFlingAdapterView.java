...
//        Log.e("TAG","onLayout222222222222222222"+mAdapter.getCount());
        mInLayout = true;
    ...
    public void changView(int startingIndex)
    {

        removeViewsInLayout(0,1);
        layoutChildren(startingIndex, 1);
        return;
//        removeViewAt(0);
//        View newView = mAdapter.getView(startingIndex, null, this);
////        removeViewsInLayout(0, LAST_OBJECT_IN_STACK);
//        removeViewsInLayout(startingIndex, LAST_OBJECT_IN_STACK);
////        makeAndAddView();
//
////        layoutChildren(0, adapterCount);
////        mAdapter.notify();
////        view = newView;
//        FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams) newView.getLayoutParams();
//        addViewInLayout(newView, startingIndex, lp, false);
//
//
////        removeAllViewsInLayout();
////        layoutChildren(0, adapterCount);
