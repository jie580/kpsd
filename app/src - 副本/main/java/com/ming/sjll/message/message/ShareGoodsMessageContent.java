...
@MessageTag(value = "KP:shareGoods", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class ShareGoodsMessageContent extends MessageContent {
...
//    }
    ...
    private ShareGoodsMessageContent(String userId, String headImg, String goodsId, String goodsTitle, String address, String payment) {
        this.userId = userId;
        this.headImg = headImg;
        this.goodsId = goodsId;
        this.goodsTitle = goodsTitle;
...
//        this.content = content;
    ...
    public static ShareGoodsMessageContent obtain(String userId, String headImg, String goodsId, String goodsTitle, String address, String payment) {
        return new ShareGoodsMessageContent(userId, headImg, goodsId, goodsTitle, address, payment);
    }


    public ShareGoodsMessageContent(Parcel in) {
...
//        ParcelUtils.writeToParcel(dest, content);
    ...
    public ShareGoodsMessageContent(byte[] data) {
        String jsonStr = null;
        try {
