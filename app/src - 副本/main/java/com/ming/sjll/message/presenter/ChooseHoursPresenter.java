...
public class ChooseHoursPresenter extends MvpPresenter<ChooseDayView> {
    ...
    public void getLongTime(String startTime) {
        getNetData(RetrofitManager.get().create(ApiService.class).getGoodsLongTime(getToken(), goods_id, startTime),
