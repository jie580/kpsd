...
public class PermissionHelper {
     ...
     * @param listener
     */
//    public static void reqCameraAndSDcard(final AppCompatActivity activity, final PermissionListener listener) {
    public static void reqCameraAndSDcard(final Activity activity, final PermissionListener listener) {
