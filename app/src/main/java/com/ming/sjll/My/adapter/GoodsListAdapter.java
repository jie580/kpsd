...
public class GoodsListAdapter extends BaseQuickAdapter<GoodsItem.DataBean, BaseViewHolder> {

    boolean isShowDelete = false;
    Context context;
    boolean isShowUser = false;

    public GoodsListAdapter(@Nullable List<GoodsItem.DataBean> data, boolean isShowDelete){
        super(R.layout.item_goods, data);
        this.isShowDelete = isShowDelete;
    }

    public GoodsListAdapter(@Nullable List<GoodsItem.DataBean> data, boolean isShowDelete,boolean isShowUser){
        super(R.layout.item_goods, data);
        this.isShowDelete = isShowDelete;
        this.isShowUser = isShowUser;
    }

    public GoodsListAdapter(@Nullable List<GoodsItem.DataBean> data){
        super(R.layout.item_goods, data);
    }
    public GoodsListAdapter(@Nullable List<GoodsItem.DataBean> data, Context context) {
        super(R.layout.item_goods, data);
