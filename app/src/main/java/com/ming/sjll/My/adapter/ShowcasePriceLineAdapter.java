...
public class ShowcasePriceLineAdapter extends BaseQuickAdapter<GoodsItem.DataBean.DataBeanX, BaseViewHolder> {


    public boolean canEdit = true;

    public ShowcasePriceLineAdapter(@Nullable List<GoodsItem.DataBean.DataBeanX> data) {
