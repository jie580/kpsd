...
public class MyTencentMap extends BaseActivity {
...
//                tencentLocation.getLatitude();
                nowCity = tencentMap.getCityName(new LatLng(tencentLocation.getLatitude(), tencentLocation.getLongitude()));
                myLocation.setLatitude(tencentLocation.getLatitude());
                myLocation.setLongitude(tencentLocation.getLongitude());
    ...
    private void makeMark(LatLng latLng) {
        ...
        View userView2 = LayoutInflater.from(MyTencentMap.this).inflate(R.layout.map_tencent_mylocation, null);
    ...
    private void moveCamera()
    {
        ...
        CameraUpdate cameraSigma =
                CameraUpdateFactory.newCameraPosition(new CameraPosition(
                        new LatLng(marker.getPosition().getLatitude()-0.002, marker.getPosition().getLongitude()), //中心点坐标，地图目标经纬度
                        17,  //目标缩放级别
...
//                locationList.add(poi);
        addressListItemAdapter = new AddressListItemAdapter(MyTencentMap.this,locationList,selectLocationLatLng,new LatLng(myLocation.getLatitude(),myLocation.getLongitude()));
