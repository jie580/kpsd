...
public class SiteFragment extends BaseFragment {
    ...
    public static SiteFragment newInstance(String project_id) {
    ...
    private void initView() {
        ...
        findViewById(R.id.add_occupation).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bottomInterPasswordDialog.setContentView(R.layout.dialog_project_site_select);
...
//        getOccupationUserList();
    ...
    private void getData()
    {
        ...
        new HttpUtil().sendRequest(Constant.PROJECT_MEMBER_ADDRESS, param, new CommonCallback() {
            @Override
    ...
    private void initVertical()
    {
        ...
        timeUserMiddleAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()) {
                    case R.id.delete:
                        DialogTextTip dialog = new DialogTextTip(getContext(), "是否确定删除该地点？");
