 ...
 * 作品挑选
 */
public class SampleUploadFragment extends BaseFragment {
    ...
    public static SampleUploadFragment newInstance(String project_id) {
        SampleUploadFragment fragment = new SampleUploadFragment();
    ...
    private void initView() {
        ...
        param.setParam("flowIdentification","work_upload");
