...
public class LocateCenterHorizontalView extends RecyclerView {
     ...
     * 初始时选中的位置
     */
    private int initPos = 50 / 2;

    private int initTopPos = 2;
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (isInit) {
                    ...
                    linearLayoutManager.scrollToPositionWithOffset(0, (-initPos) * (wrapAdapter.getItemWidth()) - wrapAdapter.itemWidth / 2);
                    isInit = false;
                }
            }
        });
