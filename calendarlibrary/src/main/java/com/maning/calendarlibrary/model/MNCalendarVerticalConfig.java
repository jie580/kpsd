...
public class MNCalendarVerticalConfig {
    ...
    //日期标记
    private List<String> mnCalendar_dateList = new LinkedList<>();
    ...
    public List<String> getMnCalendar_dateList() {
        return mnCalendar_dateList;
    }

    public void setMnCalendar_dateList(List<String> mnCalendar_dateList) {
        this.mnCalendar_dateList = mnCalendar_dateList;
    }
    ...
    public static class Builder {
        ...
        public Builder setMnCalendar_dateList(List<String> mnCalendar_countMonth) {
            mnCalendarConfig.setMnCalendar_dateList(mnCalendar_countMonth);
            return this;
        }
